...
//        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.ScrollerView, defStyle, 0);
//        setFillViewport(a.getBoolean(R.attr.fillViewportScroller, false));
//        a.recycle();
    ...
    private void initScrollView() {
        ...
        // 64dip taken from listPreferredItemHeight from Holo theme.
        TypedValue v = new TypedValue();
        v.type = TypedValue.TYPE_DIMENSION;
        v.string = "64dip";
        
        mScrollFactor = v.getDimension(getContext().getResources().getDisplayMetrics());
    }
